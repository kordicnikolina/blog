        ...
        <main class="posts-listing col-lg-8"> 
          <div class="container">
            <h2 class="mb-3 author d-flex align-items-center flex-wrap">
              <div class="avatar"><img src="${author.image}" alt="..." class="img-fluid rounded-circle"></div>
                <div class="title">
            ...
            <div class="row">
              <!-- post -->
              <c:forEach var="blog" items="${blogListAuthor}">
              <div class="post col-xl-6">
                <div class="post-thumbnail"><a href="blog-author-page?id=${blog.author.id}"><img src="${blog.image}" alt="..." class="img-fluid"></a></div>
