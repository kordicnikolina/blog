    ...
    <div class="container">
      <div class="row">
        ...
        <main class="posts-listing col-lg-8"> 
          <div class="container">
            <h2 class="mb-3" name="text">Search results for ""</h2>
            <div class="row">
              <!-- post -->
              <c:forEach var="blog" items="${blogSearch}">
              <div class="post col-xl-6">
                ...
                <div class="post-details">
                  ...
                  <a href="${blog.author.image }" class="author d-flex align-items-center flex-wrap">
                      <div class="avatar">
