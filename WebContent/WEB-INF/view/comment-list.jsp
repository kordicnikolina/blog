                  ...
                  <c:forEach var="comment" items="${commentList}">
                   <tr>
                      ...
                      <c:if test="${!comment.isSeen}">
                        <a href="comment-seen?id=${comment.id}" class="btn btn-block btn-danger btn-sm">Mark as seen</a>
                        </c:if>
                      </td>
                      <td>
                         <c:if test="${!comment.isEnabled}">
                        <a href="comment-enabled?id=${comment.id}" class="btn btn-block btn-danger btn-sm">Disable</a>
                        </c:if>
