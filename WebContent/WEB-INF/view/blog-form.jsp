            ...
            <div class="card card-primary">
              ...
              <form:hidden path="id"/>
                ...
                <div class="card-body">
                  ...
                  <div class="form-group">
                    <label>Date</label>
                    <form:input path="date" class="form-control" placeholder="Enter date yyyy-mm-dd"/>
                  </div>
                   <div class="form-group">
                  ...
                  <label>Author photo</label>
                    <form:select path="author.id" class="form-control" itemLabel="image" itemValue="id" items="${authorList}"/>
                  </div>
                   <div class="form-group">
                    <label>Author name</label>
                   <form:select path="author.id" class="form-control" itemLabel="name" itemValue="id" items="${authorList}"/>
                  </div>
                  <div class="form-group">
                   <div class="form-group">
                ...
                <label>Second image</label>
                    <form:input path="image2" type="text" class="form-control" placeholder="Enter image url"/>
                  </div>
                    <div class="form-group">
                <label>Third image</label>
                    <form:input path="image3" type="text" class="form-control" placeholder="Enter image url"/>
                  </div>
                  <div class="form-group">
                    <label>Body</label>
                    <form:textarea path="body" class="form-control" placeholder="Enter body"/>
                  </div>
                 <label>Tags</label>
                   <form:select  path="tags" itemLabel="name" itemValue="id" items="${tagList}" multiple="true" class="form-control"/>  
                  </div>
                  <div class="custom-control custom-checkbox">
                          <form:checkbox class="custom-control-input" id="customCheckbox1" path="isImportant"/>
                          <label for="customCheckbox1" class="custom-control-label">Check as important</label>
                        </div>
