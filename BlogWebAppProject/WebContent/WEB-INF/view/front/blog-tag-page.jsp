        ...
        <main class="posts-listing col-lg-8"> 
          <div class="container">
            ...
            <div class="row">
              ...
              <c:forEach var="blog" items="${blogTag}">
              <div class="post col-xl-6">
                <div class="post-thumbnail"><a href="blog-post-page?id=${blog.id}"><img src="${blog.image }" alt="..." class="img-fluid"></a></div>
                <div class="post-details">
                  ...
                  <footer class="post-footer d-flex align-items-center"> <a href="blog-author-page?id=${blog.author.id}" class="author d-flex align-items-center flex-wrap">
                    ...
                    <div class="date"><i class="icon-clock"></i> ${blog.createdAt}</div>
