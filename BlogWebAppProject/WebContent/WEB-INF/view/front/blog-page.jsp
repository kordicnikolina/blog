          ...
          <div class="container">
            <div class="row">
              ...
              <div class="post col-xl-6">
                ...
                <div class="post-details">
                  ...
                  <a href="blog-author-page?id=${blog.author.id}" class="author d-flex align-items-center flex-wrap">
                      <div class="avatar">
                      <img src="${blog.author.image }" alt="..." class="img-fluid"></div>
            ...
            <nav aria-label="Page navigation example">
              <ul class="pagination pagination-template d-flex justify-content-center">
                ...
                <li class="page-item"><a href="blog-by-page" class="page-link"> <i class="fa fa-angle-left"></i></a></li>
            
                <li class="page-item"><a href="blogpost-by-page" class="page-link active">1</a></li>
               
                <li class="page-item"><a href="blogpost-by-page" class="page-link">2</a></li>
                <li class="page-item"><a href="blogpost-by-page" class="page-link">3</a></li>
               
                <li class="page-item"><a href="blogpost-by-page"class="page-link"> <i class="fa fa-angle-right"></i></a></li>
