            ...
            <div class="card card-primary">
              ...
              <form:hidden path="id"/>
                <div class="card-body">
                 ...
                 <form:checkbox class="custom-control-input"  id="customCheckbox1" path="isUncategorized"/>
                 <label for="customCheckbox1" class="custom-control-label">Uncategorized</label>
               </div>
                </div>
                <!-- /.card-body -->
