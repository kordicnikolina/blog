        ...
        <div class="row">
          <div class="col-md-6">
            <div class="card card-primary">
              ...
              <form:form role="form" modelAttribute= "user" action="user-edit">
              ...
              <form:hidden path="authorities"/>
               ...
               <div class="card-body">
                  ...
                  <div class="callout callout-success">
                    ...
                    <div class="form-group">
                        <label>Phone</label>
                        <form:input type="tel" class="form-control" placeholder="Enter phone" path="phone"/>
                        <form:errors path="phone" cssClass="text-danger"></form:errors>
                    </div>
                    
                  <div class="form-group">
                    <label>Image</label>
                    <form:input path="image" class="form-control" placeholder="Enter image url"/>
                  </div>
              </div>
                <!-- /.card-body -->
